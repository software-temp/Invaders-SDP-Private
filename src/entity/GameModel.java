...
public class GameModel {
	...
	public EnemyShipSpecialFormation getEnemyShipSpecialFormation() {
		return enemyShipSpecialFormation;
	}
	...
	public Set<BossBullet> getBossBullets() {
		return bossBullets;
	}

	public EnemyShipFormationModel getEnemyShipFormationModel() {
		return enemyShipFormationModel;
	}

	public MidBoss getOmegaBoss() {
		return omegaBoss;
	}
	...
	public Set<DropItem> getDropItems() {
		return dropItems;
	}
	...
	public Cooldown getAchievementPopupCooldown() {
		return achievementPopupCooldown;
	}
	...
	public Cooldown getHealthPopupCooldown() {
		return healthPopupCooldown;
	}
	...
	public Cooldown getScreenFinishedCooldown() {
