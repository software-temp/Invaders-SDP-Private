...
public class GameModel {
    ...
    public final void initialize() {
        ...
        this.ship = new Ship(this.width / 2 - 100, GameScreen.ITEMS_SEPARATION_LINE_HEIGHT - 20,true);
        this.ship.setPlayerId(1);   //=== [ADD] Player 1 ===

        this.shipP2 = new Ship(this.width / 2 + 100, GameScreen.ITEMS_SEPARATION_LINE_HEIGHT - 20, false);
